...
extern "C" {
  ...
  int exact_dfio_2d(  int N, complex<double> *output, complex<double> *input, double (*phase)(double, double, double, double) )
  {
  ...
  int exact_dfio_2d_sample( int n_samples, int *sample_indexes, int N, complex<double> *output, complex<double> *input, double (*phase)(double, double, double, double) )
  {
    if (output==NULL) return 1;
    if (input==NULL) return 1;
