  ...
  for z1=0:nz-1 %loop over zones
    for z2=0:nz-1
      ...
      for ell=SL:-1:ML % start at 'top' of tree, work way down to middle
        nk = 2^ell; %number of k in current branch
        nx = N/nk; % N*2^-ell, number of x in current branch
        kB = N/nk; % N*2^-ell, number of branches as current level
        xB = 1/nx; % x-spacing in current branch
